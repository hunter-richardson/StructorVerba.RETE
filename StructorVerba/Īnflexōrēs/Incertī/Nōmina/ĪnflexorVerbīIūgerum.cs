...
namespace Īnflexōrēs.Incertī.Nōmina
{
  ...
  {
    public static readonly Lazy<ĪnflexorVerbīIūgerum> Faciendum = new Lazy<ĪnflexorVerbīIūgerum>(() => Instance);
    private ĪnflexorVerbīIūgerum()
        : base(Catēgoria.Nōmen, new Lazy<Nūntius<ĪnflexorVerbīIūgerum>>(() => new Nūntius<ĪnflexorVerbīIūgerum>()),
