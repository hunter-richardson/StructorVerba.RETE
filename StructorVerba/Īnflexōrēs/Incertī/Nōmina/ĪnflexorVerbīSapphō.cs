...
namespace Īnflexōrēs.Incertī.Nōmina
{
  ...
  {
    public static readonly Lazy<ĪnflexorVerbīSapphō> Faciendum = new Lazy<ĪnflexorVerbīSapphō>(() => Instance);
    private ĪnflexorVerbīSapphō()
        : base(Catēgoria.Nōmen, new Lazy<Nūntius<ĪnflexorVerbīSapphō>>(() => new Nūntius<ĪnflexorVerbīSapphō>()),
