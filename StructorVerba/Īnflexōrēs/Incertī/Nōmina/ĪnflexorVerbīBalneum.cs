...
namespace Īnflexōrēs.Incertī.Nōmina
{
  ...
  {
    public static readonly Lazy<ĪnflexorVerbīBalneum> Faciendum = new Lazy<ĪnflexorVerbīBalneum>(() => Instance);
    private ĪnflexorVerbīIūgerum()
        : base(Catēgoria.Nōmen, new Lazy<Nūntius<ĪnflexorVerbīBalneum>>(() => new Nūntius<ĪnflexorVerbīBalneum>()),
