...
namespace Īnflexōrēs.Incertī.Nōmina
{
  ...
  {
    public static readonly Lazy<ĪnflexorVerbīDomus> Faciendum = new Lazy<ĪnflexorVerbīDomus>(() => Instance);
    private ĪnflexorVerbīDomus()
        : base(Catēgoria.Nōmen, new Lazy<Nūntius<ĪnflexorVerbīDomus>>(() => new Nūntius<ĪnflexorVerbīDomus>()),
