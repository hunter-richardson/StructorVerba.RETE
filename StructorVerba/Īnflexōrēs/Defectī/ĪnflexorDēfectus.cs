...
namespace Īnflexōrēs.Dēfectī
{
  ...
  public abstract partial class ĪnflexorDēfectus<Hoc, Illud> : Īnflexor<Hoc, Illud>
  {
    ...
    protected ĪnflexorDēfectus(in Ēnumerātiōnēs.Catēgoria catēgoria, in Lazy<Nūntius<ĪnflexorDēfectus>> nūntius,
                               in Lazy<ĪnflexorEffectus> relātus, in params IEnumerable<Enum[]> illa)
